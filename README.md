...
## v1.3 難度重設計 + 結算畫面優化
- 難度曲線改為四段固定分數設計（0–199 / 200–599 / 600–999 / 1000+）
- 背景切換對齊難度分段
- 新手保護區：白雲 90%、平台靜止、密集間距、X 軸分區分布
- 道具生成頻率依分數段動態調整
- BRICK 平台 X 軸強制錯位
- Game over 畫面：GAME OVER 改為 Keep it up! / New Record! 動畫
- 新紀錄時全版跑分動畫 + 龍煙火慶祝 + 炫彩標題
- 煙火音效：嗚呼主音效 + 煙火背景循環音
- 排行榜新增自己排名顯示（分隔線下方）
- 首頁 Leaderboard 按鈕樣式更新
